import { FetchAllowTaskerDoAdditionalTestParams, FetchAllowTaskerDoTrainingTestAgainParams, FetchGetStatusTaskerTrainingParams, FetchUpdateTaskerProfileParams, FetchSendNotificationParams } from "../api-services";
...
import { IAskerFlashSaleForm, IAskerReferralCampaignData, IAskerReferralCampaignForm, IComboVoucherForm } from "../marketing";
import { IConditionsGetBonusByTraining, IQuizzesTrainingJourney, ITrainingJourney, ITrainingSetting } from "../tasker-journey";
...
export interface MeteorMethod extends MeteorMethodPaginationAndFilter {
        ...
        params: [
            {
                ...
                quizzes: Array<Pick<IQuizzesTrainingJourney, "question" | "answers" | "rightAnswer">>;
                videos: Array<Pick<IQuizzesTrainingJourney, "question" | "content" | "youtubeVideoId">>;
    ...
    "tasker.taskerJourney.getTrainingById": {
        ...
        return: {
            ...
            readingTime: ITrainingJourney["readingTime"];
            title: ITextLangRelease;
            quizzes: Array<Pick<IQuizzesTrainingJourney, "_id" | "question" | "answers" | "rightAnswer" | "createdAt">>;
            videos: Array<Pick<IQuizzesTrainingJourney, "_id" | "question" | "content" | "youtubeVideoId" | "createdAt">>;
            isTesting: ITrainingJourney["isTesting"];
        };
    };
        ...
        params: [
            {
                ...
                params: Pick<Partial<IQuizzesTrainingJourney>, "answers" | "rightAnswer" | "content" | "youtubeVideoId"> & Pick<IQuizzesTrainingJourney, "question">;
            }
        ];
        return: {
            message: string;
...
export type IQueryNamePaginationAndFilter = keyof MeteorMethodPaginationAndFilter;
