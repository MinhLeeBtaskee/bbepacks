...
export declare enum E_QUIZ_TYPE {
    QUIZ = "QUIZ",
    VIDEO = "VIDEO"
}
export declare enum E_CONDITION_GET_BONUS {
    TRAINING = "TRAINING"
}
...
export interface IQuizzesTrainingJourney extends IQuestionTypeVideo, IQuestionTypeQuiz {
    _id: string;
    question: string;
