...
export declare enum SORT_NUMBER_VALUE {
    ASCEND = 1,
    DESCEND = -1
}
...
export type IRangeDatePicker = 'range-date' | 'range-week' | 'range-month' | 'range-quarter' | 'range-year';
export type IDatePickerFormatted = ISingleDate | IRangeDatePicker;
export declare enum PROMOTION_VALUE_TYPE {
    MONEY = "MONEY",
